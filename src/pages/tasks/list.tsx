...
const List = ({children}:React.PropsWithChildren) => {
  ...
  return (
    ...
    <KanbanBoardContainer>
        ...
        onAddClick={()=> haddleAddCard({ stageId: 'unassigned' })}
        >
            ...
            {!taskStages.unassignedStage.length && (
                <KanbanAddCardButton 
                onClick={()=> haddleAddCard({stageId:'unassigned'})} />
            )}
        ...
        {taskStages.stages.map((column)=> (
            ...
            onAddClick={()=> haddleAddCard({stageId:column.id})}
            >
                {!isLoading && column.tasks.map((task)=> (
                    ...
                    {!column.tasks.length && (
                        <KanbanAddCardButton 
                        onClick={()=> haddleAddCard({stageId:column.id})} 
                        />
                    )}
